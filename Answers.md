...
A prop is like an object it cab be assigned key value pairs to be used across components, in order to assign values, define states, and display information.
